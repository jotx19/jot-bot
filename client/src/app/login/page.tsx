...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-svh bg-[#EDEAE4] p-3 dark:bg-[#050505] md:p-4">
      <Script
      ...
      <div
        className={cn(
          "mx-auto flex min-h-[calc(100svh-1.5rem)] w-full max-w-[1400px] overflow-hidden",
          "rounded-[1.75rem] border border-black/10 bg-[#F7F5F1]",
          "dark:border-white/10 dark:bg-[#0c0c0c] md:min-h-[calc(100svh-2rem)]"
        )}
      >
        ...
        <div className="relative flex w-full flex-col lg:w-1/2">
          <div className="relative h-28 w-full overflow-hidden lg:hidden">
            <Image
              src="/hero-bg.jpeg"
              alt=""
              fill
